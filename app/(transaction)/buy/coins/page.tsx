            ...
            <div className="max-w-xl mx-auto space-y-6">
                <div className="space-y-2">
                    ...
                    <p className="text-zinc-400">
                        Dive into the world of your favorite series with our
                        exclusive coin system. Whether you&apos;re a new reader
                        or a seasoned fan, our Coin Store offers a seamless way
                        to purchase and enjoy the latest chapters of the stories
                        you love.
                    </p>
                </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="flex items-center ml-3">
                                    <span className="text-sm font-semibold flex gap-2">
                                        <HandCoins size={20} /> {option.amount}{" "}
                                        Coins
                                    </span>
                                </div>
                            </div>
